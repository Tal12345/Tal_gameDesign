...
icon = pygame.image.load("firstCodes\Classtuff\Circle east square\Images\Pygame-Tutorials-master\Game\mole.jpg")
...
def gameLevel():
    ...
    while level:
        ...
        button("Wyjdź z gry", 620, 550, 150, 40, black, black, white, "small", "quit")
        button("Najlepsze wyniki", 30, 550, 200, 40, white, black, black, "small", "scores")
        pygame.display.update()
